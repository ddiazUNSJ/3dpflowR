...
import '../../ui/components/overview/about/about.js';
import '../../ui/components/overview/meetup/meetup.js';
...
FlowRouter.route('/', {
  name: 'App.Home',
  action() {
    BlazeLayout.render('MasterLayout',{ top:"Header",  main: 'Overview',  bottom:'Footer'});
